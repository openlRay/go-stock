...
export function AbortAnnouncementAIAnalysis(arg1:string):Promise<void>;
...
export function CopyAIConfig(arg1:number):Promise<data.AIConfig>;

export function CreateAIConfig(arg1:data.AIConfig):Promise<data.AIConfig>;
...
export function DeleteAIConfig(arg1:number):Promise<data.DeleteAIConfigResult>;
...
export function UpdateAIConfig(arg1:data.AIConfig):Promise<data.AIConfig>;
